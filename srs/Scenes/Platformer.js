class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        if (!my.sprite.player1) {
            ...
            my.sprite.player1.winText = this.add.text(my.sprite.player1.x-200, game.config.height/2 - 200, 'You Win :)', { fontSize: '40px', fill: '#006400' });
            my.sprite.player1.loseText = this.add.text(my.sprite.player1.x-200, game.config.height/2 - 200, 'You Lose :(', { fontSize: '40px', fill: '#8B0000' });
        ...
        if (!my.sprite.player2) {
            ...
            my.sprite.player2.winText = this.add.text(my.sprite.player2.x-50, game.config.height/2 - 200, 'You Win :)', { fontSize: '40px', fill: '#006400' });
            my.sprite.player2.loseText = this.add.text(my.sprite.player2.x-50, game.config.height/2 - 200, 'You Lose :(', { fontSize: '40px', fill: '#8B0000' });
        ...
        this.input.keyboard.on('keydown-Y', () => {
            this.startGame = true;
            my.sprite.player1.title.visible = false;
            my.sprite.player1.title2.visible = false;
        });
...
this.initializeKeybinds(
    ...
    resetGame() {
        ...
        this.resetTroopGroup(my.sprite.player1.troop1Group);
        this.resetTroopGroup(my.sprite.player1.troop2Group);
        this.resetTroopGroup(my.sprite.player1.troop3Group);
        this.resetTroopGroup(my.sprite.player1.troop4Group);

        this.resetTroopGroup(my.sprite.player2.troop1Group);
        this.resetTroopGroup(my.sprite.player2.troop2Group);
        this.resetTroopGroup(my.sprite.player2.troop3Group);
        this.resetTroopGroup(my.sprite.player2.troop4Group);
    ...
    checkWin() {
        if (this.my.sprite.player1.hp <= 0) {
            ...
            this.my.sprite.player1.credits.visible = true;
